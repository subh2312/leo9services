...
const OurWorks = () => {
  return (
    <div className="h-screen flex flex-col lg:space-y-8 space-y-30 pl-32 lg:pl-1 lg:items-center">
      <div className="lg:pb-20 pb-80 text-center">
        <h1 className="text-4xl md:text-7xl h-[30vh] md:h-[50vh] w-screen md:w-[70vw] text-center">
